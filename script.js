...
const quizArray = [
    ...
    {
        id: "3",
        question: "How do you apply a shadow effect to an element in CSS?",
        options: ["box-shadow: 2px 2px gray;", "shadow: 2px 2px gray;","text-shadow: 2px 2px gray;", "element-shadow: 2px 2px gray;"],
        correct: "box-shadow: 2px 2px gray;",
    },
    {
        id: "4",
